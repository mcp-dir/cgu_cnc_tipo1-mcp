...
Controladoria-Geral da União: Certidão Negativa Correcional - Entes Privados (ePAD, CGU-PJ, CEIS, CNEP e CEPIM) usa um único endpoint público (`https://api.mcp.ai/p_cgu_cnc_tipo1`).
