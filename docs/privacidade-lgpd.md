...
Controladoria-Geral da União: Certidão Negativa Correcional - Entes Privados (ePAD, CGU-PJ, CEIS, CNEP e CEPIM) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [cgu_cnc_tipo1@mcp.ai](mailto:cgu_cnc_tipo1@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
